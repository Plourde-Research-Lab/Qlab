...
//	7/8/2013	RD	Added declaration for fnLSG_GetDLLVersion
//					ANSI-C version
...
VNX_FSYNSTH_API int fnLSG_GetDLLVersion();
...
VNX_FSYNSTH_API int fnLSG_GetPowerLevelAbs(DEVID deviceID);
